    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('m_file', models.FileField(null=True, upload_to='')),
                ('m_actors', models.CharField(max_length=100)),
                ('m_poster', models.ImageField(null=True, upload_to='')),
            ],
        ),
        migrations.CreateModel(
            name='season',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s_cover_pic', models.ImageField(null=True, upload_to='')),
            ],
        ),
        migrations.CreateModel(
            name='episodes',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('e_file', models.FileField(null=True, upload_to='')),
                ('which_episode', models.IntegerField(default=1)),
                ('episode_name', models.CharField(max_length=100)),
                ('season_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='StreamNest_app.season')),
            ],
        ),
        migrations.AddField(
            model_name='season',
            name='series_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='StreamNest_app.series'),
        ),
        migrations.CreateModel(
            name='Login',
            fields=[
